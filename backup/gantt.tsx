...
//       include: {
//         dependencies: { // Alterado de 'dependency' para 'dependencies'
//           include: {
//             predecessor: true
//           }
//         },
//         predecessorDependencies: { // Adicionado
//           include: {
//             task: true
//           }
//         },
...
//       Predecessor: [
//         ...task.dependencies.map(d => `${d.predecessorId}-${d.type}`),
//         ...task.predecessorDependencies.map(pd => `${pd.taskId}-${pd.type}`)
//       ].join(','),
//       uniqueID: task.uniqueID
//     }));

//     return json({ initialData: formattedTasks });
//   } catch (error) {
//     console.error('Erro ao carregar dados:', error);
//     return json({ initialData: [], error: 'Falha ao carregar dados' }, 500);
//   }
// }
  ...
  return (
    <div style={{ margin: '20px' }}>
      ...
      <GanttComponent
        ...
        //dataSource={initialData} // Dados pré-carregados
        // ref={gantt => {
